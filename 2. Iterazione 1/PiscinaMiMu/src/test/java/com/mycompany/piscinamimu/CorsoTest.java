...
public class CorsoTest {
    ...
    void aggiungiLezione_giaPresente() throws Exception {
        ...
        assertThrows(LezioneGiaPresenteException.class, () -> corso.aggiungiLezione(l));
    }

    @Test
    void aggiungiLezione_programmazionePiena() throws Exception {
        // durata = 2 → massimo 2 lezioni
        corso.aggiungiLezione(new Lezione("L1", "10:00", "11:00"));
        corso.aggiungiLezione(new Lezione("L2", "11:00", "12:00"));

        assertThrows(ProgrammazionePienaException.class, () ->
                corso.aggiungiLezione(new Lezione("L3", "12:00", "13:00")));
    }
    ...
    @Test
    void eliminaLezione_nonPresente() {
